// Oracle Corporation Enriched Data - FY2024
// Auto-generated enriched data file

import { WrappedData } from "@/types/wrapped";

export const orclData: Partial<WrappedData> = {
  meta: {
    ticker: "ORCL",
  ...
  personality: {
    type: "The Database Giant",
    emoji: "🗄️",
    description: "Oracle Corporation in 2024 continued to execute on its strategic priorities.",
    traits: ["Growth", "Innovation", "Leadership"],
  },
  aiSummary: "Oracle Corporation's fiscal year 2024 showed +5% revenue growth to $55B. The company continues to focus on its core business while investing in future growth opportunities.",
  generatedAt: new Date().toISOString(),
};

export const orclBuzzwords = [
  {
    "word": "Growth",
    "count": 150,
    "size": "lg"
