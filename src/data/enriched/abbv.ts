// AbbVie Inc. Enriched Data - FY2024
// Auto-generated enriched data file

import { WrappedData } from "@/types/wrapped";

export const abbvData: Partial<WrappedData> = {
  meta: {
    ticker: "ABBV",
    name: "AbbVie Inc.",
    fiscalYear: 2024,
  ...
  personality: {
    type: "The Humira Successor",
    emoji: "🧬",
    description: "AbbVie Inc. in 2024 continued to execute on its strategic priorities.",
    traits: ["Growth", "Innovation", "Leadership"],
  },
  aiSummary: "AbbVie Inc.'s fiscal year 2024 showed +5% revenue growth to $55B. The company continues to focus on its core business while investing in future growth opportunities.",
  generatedAt: new Date().toISOString(),
};

export const abbvBuzzwords = [
  {
    "word": "Growth",
    "count": 150,
    "size": "lg"
