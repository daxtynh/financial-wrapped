// Goldman Sachs Enriched Data - FY2024
// Auto-generated enriched data file

import { WrappedData } from "@/types/wrapped";

export const gsData: Partial<WrappedData> = {
  meta: {
    ticker: "GS",
    name: "Goldman Sachs",
    fiscalYear: 2024,
  ...
  financials: {
    ...
    revenueGrowth: 0.05,
    grossProfit: 25000000000.0,
    grossMargin: 0.5,
    operatingIncome: 10000000000.0,
  ...
  personality: {
    type: "The Deal Maker",
    emoji: "📊",
    description: "Goldman Sachs in 2024 continued to execute on its strategic priorities.",
    traits: ["Growth", "Innovation", "Leadership"],
  },
  aiSummary: "Goldman Sachs's fiscal year 2024 showed +5% revenue growth to $50B. The company continues to focus on its core business while investing in future growth opportunities.",
  generatedAt: new Date().toISOString(),
};

export const gsBuzzwords = [
  {
    "word": "Growth",
    "count": 150,
    "size": "lg"
